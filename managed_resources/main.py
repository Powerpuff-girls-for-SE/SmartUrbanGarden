...
def main():
    ...
    areas.append(area1)
    area2 = GardenArea(area="Basil", light=5000, temperature=25, humidity=70, moisture=70)
    areas.append(area2)
    area3 = GardenArea(area="Succulent",  light=10000, temperature=25, humidity=40, moisture=30)
    areas.append(area3)
    area4 = GardenArea(area="FernOasis", light=1500, temperature=22, humidity=75, moisture=60)
    areas.append(area4)
